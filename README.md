...
| ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Precision** | Total number of sentences: 2,737<br>Number of sentences with matched triggers (that were not identified) : 1238<br>Number of matches: 7<br>Number of matches filtered by NER: 0<br>Precision: **99.4% - 100%**<br>(view procedure and results [here](results/ud_precision.ipynb)) | Total number of lines: 250<br/>Number of sentences with matched triggers (that were not identified) : 115<br/>Number of matches: 6<br/>Number of matches filtered by NER: 0<br/>Precision: **94.8% - 100%**<br>(view procedure and results [here](results/ucca_precision.ipynb)) |
| **Recall**    | Total number of sentences: 76<br/>Total number sentences with usable UD parses: 72 <br/>Number of matches: 27<br/>Recall: **37.5%**<br>(view procedure and results [here](results/ud_recall.ipynb)) | Total number of sentences: 76<br/>Total number of sentences with usable UCCA parses: 75<br/>Number of matches: 15<br/>Recall: **20%**<br>(view procedure and results [here](results/ucca_recall.ipynb)) |
